...
import { ContactShadows, Environment, useGLTF, OrbitControls, useFBX } from "@react-three/drei"
...
function Shoe() {
  ...
  const { nodes, materials } = useGLTF("./assets/vr-model3d/shoe-draco.glb")
...
function ModelFBX() {
    ...
    const fbx = useFBX('./assets/vr-model3d/hr-003.fbx')
  return <primitive object={fbx} scale={(0.001, 0.001, 0.001)} dispose={null} />
